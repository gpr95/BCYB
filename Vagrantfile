...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "router1" do |router1|
	...
	router1.vm.network "private_network", ip: "10.9.9.8", virtualbox__intnet: "internet-1"
  ...
  config.vm.define "router2" do |router2|
	...
	router2.vm.network "private_network", ip: "10.9.9.9", virtualbox__intnet: "internet-1"
  ...
  config.vm.define "n2" do |n2|
	...
	n2.vm.hostname = "n2"
	n2.vm.network "private_network" , ip: "172.16.1.3",
		virtualbox__intnet: "intnet-1"
  end
